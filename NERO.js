...
exec("rm -rf 𝐍𝐄𝐑𝐎-𝐒𝐂𝐑𝐈𝐏𝐓/𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒/data && mkdir -p 𝐍𝐄𝐑𝐎-𝐒𝐂𝐑𝐈𝐏𝐓/𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒/data && rm -rf 𝐍𝐄𝐑𝐎-𝐒𝐂𝐑𝐈𝐏𝐓/𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒/tad/* ", (error, stdout, stderr) => {
    if (error) {
...
const logger = require("./𝐒𝐘𝐒𝐓𝐄𝐌-𝐍𝐄𝐑𝐎/utils/log.js");
const login = require("./𝐒𝐘𝐒𝐓𝐄𝐌-𝐍𝐄𝐑𝐎/FCA-AYOUB");
const axios = require("axios");
const listPackage = JSON.parse(readFileSync('./package.json')).dependencies;
const listbuiltinModules = require("module").builtinModules;
console.log(chalk.bold.hex("#03f0fc").bold("[ NERO ] » ") + chalk.bold.hex("#fcba03").bold("Initializing variables..."));
...
global.utils = require("./𝐒𝐘𝐒𝐓𝐄𝐌-𝐍𝐄𝐑𝐎/utils");
...
var configValue;
try {
    global.client.configPath = join(global.client.mainPath, "config894894.json");
...
const { Sequelize, sequelize } = require("./𝐒𝐘𝐒𝐓𝐄𝐌-𝐍𝐄𝐑𝐎/includes/database");
...
const langFile = (readFileSync(`${__dirname}/./𝐒𝐘𝐒𝐓𝐄𝐌-𝐍𝐄𝐑𝐎/languages/${global.config.language || "en"}.lang`, { encoding: 'utf-8' })).split(/\r?\n|\r/);
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        global.client.timeStart = new Date().getTime(),
            function () {
                const listCommand = readdirSync(global.client.mainPath + '/𝐍𝐄𝐑𝐎-𝐒𝐂𝐑𝐈𝐏𝐓/𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒/').filter(command => command.endsWith('.js') && !command.includes('example') && !global.config.commandDisabled.includes(command));
                for (const command of listCommand) {
                    try {
                        var module = require(global.client.mainPath + '/𝐍𝐄𝐑𝐎-𝐒𝐂𝐑𝐈𝐏𝐓/𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒/' + command);
            ...
            function() {
                const events = readdirSync(global.client.mainPath + '/𝐍𝐄𝐑𝐎-𝐒𝐂𝐑𝐈𝐏𝐓/𝐄𝐕𝐄𝐍𝐓𝐒').filter(event => event.endsWith('.js') && !global.config.eventDisabled.includes(event));
                for (const ev of events) {
                    try {
                        var event = require(global.client.mainPath + '/𝐍𝐄𝐑𝐎-𝐒𝐂𝐑𝐈𝐏𝐓/𝐄𝐕𝐄𝐍𝐓𝐒/' + ev);
        ...
        const listener = require('./𝐒𝐘𝐒𝐓𝐄𝐌-𝐍𝐄𝐑𝐎/includes/listen')(listenerData);
        ...
        logger(`𝑴𝑰𝑹𝑨𝑰 ✨`, '[ It was modified by AYOUB ]');
...
(async() => {
    try {
        ...
        authentication.sequelize = sequelize;
        const models = require('./𝐒𝐘𝐒𝐓𝐄𝐌-𝐍𝐄𝐑𝐎/includes/database/model')(authentication);
